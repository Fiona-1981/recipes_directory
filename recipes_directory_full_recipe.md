...
INSERT INTO recipes (name, cooking_time, rating) VALUES ('Dumplings', '65', '4');
...
# Repository class
# (in lib/recipes_directory_repository.rb)
...
class RecipeRepository
  ...
  def find(id)
    # Executes the SQL query:
    # SELECT id, name, cooking_timecooking_time, rating FROM recipes WHERE id = $1;
...
recipes[0].cooking_time # =>  '65'
recipes[0].rating # =>  '4'

recipes[1].id # =>  2
recipes[1].name # =>  'Duck Ragu'
...
# file: spec/recipes_directory_spec.rb
